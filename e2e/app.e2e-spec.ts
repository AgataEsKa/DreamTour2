...
//
// const expectedH1 = 'Dream Tour';
// const expectedTitle = `${expectedH1}`;
// const targetTour = { id: 1, name: 'Lato Turnus 1' };  //id: 1, name: 'Lato Turnus 1'
// const targetTourHomeIndex = 1;
// const nameSuffix = 'X';
...
//       termin: s.substr(s.indexOf(' ') + 2),
//       location: s.substr(s.indexOf(' ') + 3),
//       resort: s.substr(s.indexOf(' ') + 4),
//       coordinators: s.substr(s.indexOf(' ') + 5),
//       schedule: s.substr(s.indexOf(' ') + 6),
//     };
//   }
//
...
//       return { id: +strings[0], name: strings[1], termin: strings[3],
//       location: strings[4], resort: strings[5],
//       coordinators: strings[6], schedule: strings[7]};
//   }
//
...
//     });
//
//     const expectedViewNames = ['Home', 'Tours', 'About Us', 'Edit/Add A Tour',
//       'MakeReservation', 'Contact Us', 'Login'];
//
...
//     });
//
//     it(`selects and routes to ${targetTour.name} details`, homeSelectTargetTour);
//
...
//       browser.waitForAngular(); // seems necessary to gets tests to pass for toh-pt6
//
//       let targetHeroElt = getPageElts().topTours.get(targetTourHomeIndex);
...
//       expect(toursAfter[numTours]).toEqual({id: maxId + 1, name: newHeroName});
//     });
//   });
//
...
//     let tour = await Tour.fromDetail(page.tourDetail);
//     expect(tour.id).toEqual(targetTour.id);
//     expect(tour.name).toEqual(newHeroName.toUpperCase());
//   }
//
// });
//
